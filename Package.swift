...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TanxSDKBinary",
            url: "https://github.com/RevinSun/TanxSDK-SPM/releases/download/3.7.28/TanxSDK.xcframework.zip",
            checksum: "81e954ac61eabed29f345de7bf174d9b3bd76abf67311873505443ba61098d4c"
        ),
        .binaryTarget(
            name: "TNXASDK",
            url: "https://github.com/RevinSun/TanxSDK-SPM/releases/download/3.7.28/TNXASDK.xcframework.zip",
            checksum: "62884545a12200f27c8abfc48224c1e5b8cbae427299af16a89fb6d0a1508737"
        ),
        .binaryTarget(
            name: "TanxMonitor",
            url: "https://github.com/RevinSun/TanxSDK-SPM/releases/download/3.7.28/TanxMonitor.xcframework.zip",
