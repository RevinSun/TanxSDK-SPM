...
- TanxSDK 从 3.7.24 版本开始支持 SwiftPM。要使用 SwiftPM，请使用 Xcode 11 以上版本打开项目。点击 `File` -> `Swift Packages` -> `Add Package Dependency`，输入[TanxSDK 仓库的 URL](https://github.com/Alimama-TanxSDK/TanxSDK.git)。或登录 Xcode 的 GitHub 帐户后直接输入TanxSDK进行搜索。  
